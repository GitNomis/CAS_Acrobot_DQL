...
class CustomAcrobot(environment.Environment):
    """
    ...
    def step_env(
        ...
        success_angle = (
            -jnp.cos(joint_angle1) - jnp.cos(joint_angle2 + joint_angle1) > params.success_height_threshold
        )
        ...
        return spaces.Dict(
            {
                ...
                "success_streak": spaces.Discrete(params.success_streak_threshold + 1)
            }
        )
